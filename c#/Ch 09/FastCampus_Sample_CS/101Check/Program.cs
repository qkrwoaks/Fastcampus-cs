...
namespace _101_Check
{
    ...
    class Program
    {
        ...
        {
            if (hashTable.ContainsKey(id)) return id; return -1;
        }
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (selID >= 0)
                {
                    ...
                    Console.WriteLine("국어 점수 : " + selCStudent.Kor);
                    Console.WriteLine("수학 점수 : " + selCStudent.Math);
                    Console.WriteLine("영어 점수 : " + selCStudent.Eng);

                    int total = selCStudent.GetTotal();

                    Console.WriteLine("총점 : " + total);
                    Console.WriteLine("평균 : " + total / hashStudents.Count);
                    Console.WriteLine();
                }
                else
                {
